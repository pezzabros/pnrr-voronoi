...
var app = (function () {
    ...
    var d3VoronoiTreemap = createCommonjsModule(function (module, exports) {
    (function (global, factory) {
      factory(exports, d3VoronoiMap) ;
    }(commonjsGlobal, function (exports,voronoiMap) {
    ...
    var d3VoronoiTreemap$1 = /*@__PURE__*/getDefaultExportFromCjs(d3VoronoiTreemap);

    var d3VT = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), d3VoronoiTreemap, {
        'default': d3VoronoiTreemap$1
    }));
    ...
    // (116:2) {#if legend.length}
    function create_if_block(ctx) {
    	let each_1_anchor;
    	let each_value = /*legend*/ ctx[0];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*legend, color*/ 257) {
    				each_value = /*legend*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    // (117:3) {#each legend as g}
    function create_each_block(ctx) {
    	let div1;
    	let div0;
    	let t_value = /*g*/ ctx[10] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			t = text$1(t_value);
    			attr_dev(div0, "class", "dot svelte-d0p9id");
    			set_style(div0, "background-color", /*color*/ ctx[8](/*g*/ ctx[10]));
    			add_location(div0, file, 117, 28, 3294);
    			attr_dev(div1, "class", "legend-item svelte-d0p9id");
    			add_location(div1, file, 117, 3, 3269);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*legend*/ 1 && t_value !== (t_value = /*g*/ ctx[10] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	let div8;
    	let a4;
    	let if_block = /*legend*/ ctx[0].length && create_if_block(ctx);

    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Dove verranno allocati i fondi del Piano Nazionale di Ripartenza e Resilienza?";
    			t1 = space();
    			div2 = element("div");
    			svg = svg_element("svg");
    			t2 = space();
    			div1 = element("div");
    			t3 = text$1(/*tooltipLabel*/ ctx[3]);
    			div0 = element("div");
    			t4 = text$1(/*tooltipValue*/ ctx[4]);
    			t5 = space();
    			div3 = element("div");
    			...
    			div4 = element("div");
    			t7 = text$1("Made with ❤️ for 🇮🇹  by ");
    			a0 = element("a");
    			a0.textContent = "Daniele Pezzatini(@pezzabros)";
    			t9 = space();
    			div5 = element("div");
    			t10 = text$1("Data from ");
    			a1 = element("a");
    			a1.textContent = "@sapomnia.";
    			t12 = space();
    			div6 = element("div");
    			t13 = text$1("Chart inspired by this ");
    			a2 = element("a");
    			a2.textContent = "New York Times article.";
    			t15 = space();
    			div7 = element("div");
    			t16 = text$1("Crafted with Svelte, D3, and D3 Voronoi Treemap. ");
    			a3 = element("a");
    			a3.textContent = "RawGraphs";
    			t18 = text$1(" for data exploration.");
    			t19 = space();
    			div8 = element("div");
    			a4 = element("a");
    			a4.textContent = "ℹ️  What is a Voronoi diagram?";
    			attr_dev(h1, "class", "svelte-d0p9id");
    			add_location(h1, file, 109, 1, 2892);
    			attr_dev(svg, "viewBox", "[0 0 " + /*width*/ ctx[6] + " " + /*height*/ ctx[7] + "]");
    			attr_dev(svg, "class", "svelte-d0p9id");
    			add_location(svg, file, 111, 2, 3003);
    			attr_dev(div0, "class", "value svelte-d0p9id");
    			add_location(div0, file, 112, 82, 3145);
    			attr_dev(div1, "class", "tooltip svelte-d0p9id");
    			set_style(div1, "top", /*tooltipY*/ ctx[2] + "px");
    			set_style(div1, "left", /*tooltipX*/ ctx[1] + "px");
    			add_location(div1, file, 112, 2, 3065);
    			attr_dev(div2, "class", "chart svelte-d0p9id");
    			add_location(div2, file, 110, 1, 2981);
    			attr_dev(div3, "class", "legend svelte-d0p9id");
    			add_location(div3, file, 114, 1, 3200);
    			attr_dev(a0, "href", "https://twitter.com/pezzabros");
    			add_location(a0, file, 122, 33, 3434);
    			attr_dev(div4, "class", "svelte-d0p9id");
    			add_location(div4, file, 122, 2, 3403);
    			attr_dev(a1, "href", "https://github.com/sapomnia/Piano-nazionale-di-ripartenza-e-resilienza/blob/main/PNRR.csv");
    			add_location(a1, file, 123, 17, 3527);
    			attr_dev(div5, "class", "svelte-d0p9id");
    			add_location(div5, file, 123, 2, 3512);
    			attr_dev(a2, "href", "https://www.nytimes.com/2021/04/28/upshot/biden-families-plan-american-rescue-infrastructure.html");
    			add_location(a2, file, 124, 30, 3678);
    			attr_dev(div6, "class", "svelte-d0p9id");
    			add_location(div6, file, 124, 2, 3650);
    			attr_dev(a3, "href", "https://rawgraphs.io/");
    			add_location(a3, file, 125, 56, 3876);
    			attr_dev(div7, "class", "svelte-d0p9id");
    			add_location(div7, file, 125, 2, 3822);
    			attr_dev(a4, "href", "https://en.wikipedia.org/wiki/Voronoi_diagram");
    			add_location(a4, file, 126, 7, 3957);
    			attr_dev(div8, "class", "svelte-d0p9id");
    			add_location(div8, file, 126, 2, 3952);
    			attr_dev(footer, "class", "svelte-d0p9id");
    			add_location(footer, file, 121, 1, 3392);
    			attr_dev(main, "class", "svelte-d0p9id");
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*tooltipLabel*/ 8) set_data_dev(t3, /*tooltipLabel*/ ctx[3]);
    			if (dirty & /*tooltipValue*/ 16) set_data_dev(t4, /*tooltipValue*/ ctx[4]);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let width = 500;
    	let height = 500;
    	let color = ordinal(["#7F3C8D", "#11A579", "#3969AC", "#F2B701", "#E73F74", "#80BA5A", "#E68310"]);
    	let el;
    	let { legend = [] } = $$props;
    	let { tooltipX = 0 } = $$props;
    	let { tooltipY = 0 } = $$props;
    	let { tooltipLabel = "" } = $$props;
    	let { tooltipValue = "" } = $$props;

    	onMount(async () => {
    		let PNNTData = await csv("https://raw.githubusercontent.com/sapomnia/Piano-nazionale-di-ripartenza-e-resilienza/main/PNRR.csv", obj => ({
    			...obj,
    			value: parseFloat(obj["Spesa (mld €)"].replace(",", "."))
    		}));

    		let groupedData = group(PNNTData, d => d["Missione"], d => d["Componenti"], d => d["Investimenti e riforme"]);
    		$$invalidate(0, legend = Array.from(groupedData.keys()));
    		let rootNode = hierarchy(groupedData);
    		...
    		let computeCirclingPolygon = radius => {
    			var _2PI = 2 * Math.PI;
    			var points = 180, increment = _2PI / points, circlingPolygon = [];
    		...
    		let voronoiTreemap = d3VoronoiTreemap.voronoiTreemap().clip(circlingPolygon); /*[
    [0, 0],
    [0, height],
    [width, height],
    [width, 0],
    		...
    		select(el).append("text").attr("class", "tooltip").style("font-size", "9px").attr("text-anchor", "middle");

    		select(el).selectAll("path").data(leaves).enter().append("path").attr("d", function (d) {
    			// d is a node
    			...
    			if (d.depth == 4) return color(d.parent.parent.parent.data[0]); else return "white";
    		}).style("opacity", 0.7).style("stroke-width", d => {
    			return d.depth > 2 ? 1 : 2;
    		}).style("stroke", "#ffffff").attr("transform", "translate(3,3)").on("mouseover", function (e, d) {
    			let pos = centroid$1(d.polygon);
    			select(this).style("opacity", 1);
    			$$invalidate(1, tooltipX = pos[0]);
    			$$invalidate(2, tooltipY = pos[1]);
    			$$invalidate(3, tooltipLabel = d.data["Investimenti e riforme"]);
    			$$invalidate(4, tooltipValue = d.data["value"] + "(mld €)");
    		}).on("mouseout", function (e, d) {
    			$$invalidate(3, tooltipLabel = "");
    			$$invalidate(4, tooltipValue = "");
    			select(this).style("opacity", 0.7);
    		});
    	});

    	const writable_props = ["legend", "tooltipX", "tooltipY", "tooltipLabel", "tooltipValue"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("tooltipX" in $$props) $$invalidate(1, tooltipX = $$props.tooltipX);
    		if ("tooltipY" in $$props) $$invalidate(2, tooltipY = $$props.tooltipY);
    		if ("tooltipLabel" in $$props) $$invalidate(3, tooltipLabel = $$props.tooltipLabel);
    		if ("tooltipValue" in $$props) $$invalidate(4, tooltipValue = $$props.tooltipValue);
    	};
